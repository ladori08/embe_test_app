...
const buttonVariants = cva(
  'inline-flex min-h-10 items-center justify-center rounded-xl px-4 py-2 text-center text-sm font-semibold leading-tight transition-colors disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
