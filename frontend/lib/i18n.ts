...
const dictionaries: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'admin.ingredients.bulkImportHint': 'Paste directly from Excel (tab-separated) or CSV. Required columns: name, unit, currentStock.',
    ...
    'admin.ingredients.unitCost': 'Unit cost (optional)',
    'admin.ingredients.invalidUnitCost': 'Unit cost must be a non-negative number.',
  ...
  vi: {
    ...
    'admin.ingredients.bulkImportHint': 'Dán trực tiếp từ Excel (tab) hoặc CSV. Bắt buộc có cột: name, unit, currentStock.',
    ...
    'admin.ingredients.unitCost': 'Đơn giá nhập (không bắt buộc)',
    'admin.ingredients.invalidUnitCost': 'Đơn giá phải là số không âm.',
